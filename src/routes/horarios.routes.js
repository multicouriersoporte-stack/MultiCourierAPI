...
import { verificarToken } from "../middlewares/auth.middleware.js"; // ajusta la ruta según dónde guardaste el archivo
...
router.get("/intercambios/mis-intercambios", verificarToken, misIntercambios);
